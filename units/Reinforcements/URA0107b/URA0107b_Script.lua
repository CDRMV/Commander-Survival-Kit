...
URA0107b = Class(CAirUnit) {
    ...
    OnStopBeingBuilt = function(self,builder,layer)
		...
		self.Station09:AttachBoneTo(0, self, 'Attachpoint_sml_02')
		self.Station10 = CreateUnitHPR('url0106', self:GetArmy(), position.x, position.y, position.z, 0, 0, 0)
		self.Station10:AttachBoneTo(0, self, 'Attachpoint_sml_03')
		self.Station08 = CreateUnitHPR('url0106', self:GetArmy(), position.x, position.y, position.z, 0, 0, 0)
		self.Station08:AttachBoneTo(0, self, 'Attachpoint_sml_04')
		self.Station09 = CreateUnitHPR('url0106', self:GetArmy(), position.x, position.y, position.z, 0, 0, 0)
