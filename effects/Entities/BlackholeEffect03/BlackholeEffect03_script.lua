...
BlackholeEffect03 = Class(EmitterProjectile) {

    FxTrails = CSKEffectTemplate.NukeBlackholeFireballTrail,
    ...
    EffectThread = function(self)
        ...
        local emitters = {}
        for k, v in CSKEffectTemplate.NukeBlackholeFireball do
    ...
    OnImpact = function(self, targetType, targetEntity)
        for k, v in CSKEffectTemplate.NukeBlackholeFireballHit do
