...
Blackhole = Class(NullShell) {
    ...
    AftermathFireArmsRandom = function(self, bag, lifetime, wreck)
        ...
        local FireArmTempl = { CSKEffectTemplate.NukeBlackholeFireArmSegment1, CSKEffectTemplate.NukeBlackholeFireArmSegment2,
                               CSKEffectTemplate.NukeBlackholeFireArmSegment3, CSKEffectTemplate.NukeBlackholeFireArmSegment4,
                               CSKEffectTemplate.NukeBlackholeFireArmSegment5, }
