...
SmallBlackhole = Class(NullShell) {
    BlackholeCoreFx = CSKEffectTemplate.NukeBlackholeCore,
    BlackholeDissipatingFx = CSKEffectTemplate.NukeBlackholeDissipating,
    DissipatedFx = CSKEffectTemplate.NukeBlackholeDissipated,
    FlashFx = CSKEffectTemplate.NukeBlackholeFlash,
    GenericFx = CSKEffectTemplate.NukeBlackholeGeneric,
    RadiationBeams = CSKEffectTemplate.NukeBlackholeRadiationBeams,
    RadiationBeamLengths = CSKEffectTemplate.NukeBlackholeRadiationBeamLengths,
    RadiationBeamThickness = CSKEffectTemplate.NukeBlackholeRadiationBeamThickness,
    logo = false,
    ...
    CreateWreckage = function(self)
        local wreckBp = '/mods/Commander Survival Kit/effects/Entities/BlackholeLeftover/BlackholeLeftover_prop.bp'
        local wreckScale = 1
    ...
    CoreEffects = function(self, bag, lifetime)
        ...
        CreateLightParticleIntel( self, -1, self.Army, (10 * self.NukeBlackHoleFxScale), 2, 'glow_02', 'ramp_green_06')
    ...
    CloudsThread = function(self, bag, lifetime)
        ...
        local projBp = '/mods/Commander Survival Kit/effects/entities/BlackholeEffect01/BlackholeEffect01_proj.bp'
    ...
    CloudsThread2 = function(self, bag, lifetime)
        ...
        local projBp = '/mods/Commander Survival Kit/effects/entities/BlackholeEffect02/BlackholeEffect02_proj.bp'
    ...
    LightningThread = function(self, bag, lifetime)
        ...
        --local beamBps = { CSKEffectTemplate.NukeBlackholeEnergyBeam1, CSKEffectTemplate.NukeBlackholeEnergyBeam2, CSKEffectTemplate.NukeBlackholeEnergyBeam3, }
        --local fxBp = CSKEffectTemplate.NukeBlackholeEnergyBeamEnd
            ...
            for k, entity in entities do
                ...
                if entity.counter <= 0 then  -- if counter is 0 destroy beam and maybe create a new one
                    ...
                    if Random( 1, 100) <= chance then
                        ...
                        --bag:Add( entity.fx )
                        CreateLightParticleIntel( entity, -1, self.Army, 3, 5, 'glow_03', 'ramp_green_06')
    ...
    PropThread = function(self, bag, lifetime)
        ...
        local CreateEffect = function(self, bag, lifetime, pos)
            ...
            bag:Add( entity )
            self.Trash:Add( entity )
            for k, v in CSKEffectTemplate.BlackholePropEffects do
    ...
    AftermathExplosion = function(self, bag, lifetime, wreck)
        ...
        CreateLightParticleIntel (self, -1, self.Army, (10 * self.NukeBlackHoleFxScale), 10, 'glow_03', 'ramp_green_06')
        ...
        CreateDecal(pos, orientation, 'Crater01_albedo', '', 'Albedo', 10, 10, 1200, 0, self.Army)
        CreateDecal(pos, orientation, 'Crater01_normals', '', 'Normals', 10, 10, 1200, 0, self.Army)
        CreateDecal(pos, orientation, 'nuke_scorch_003_albedo', '', 'Albedo', 10, 10, 1200, 0, self.Army)
    ...
    AftermathFireBalls = function(self, bag, lifetime, wreck)
        ...
        local projBp = '/mods/Commander Survival Kit/effects/entities/BlackholeEffect03/BlackholeEffect03_proj.bp'
    ...
    AftermathFireArmsRandom = function(self, bag, lifetime, wreck)
        ...
        local FireCntrTempl =  CSKEffectTemplate.NukeBlackholeFireArmCenter1
		local FireCntrTemp2 =  CSKEffectTemplate.NukeBlackholeFireArmCenter3
        ...
        for k, v in FireCntrTempl do
            local emit = CreateEmitterAtEntity( self, self.Army, v ):ScaleEmitter( self.NukeBlackHoleFxScale + 0.5)
            self.Trash:Add( emit )
            bag:Add( emit )
		...
		for k, v in FireCntrTemp2 do
            local emit = CreateEmitterAtEntity( self, self.Army, v ):ScaleEmitter( self.NukeBlackHoleFxScale)
            self.Trash:Add( emit )
            bag:Add( emit )
        end
