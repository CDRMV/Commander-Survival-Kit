...
MediumBlackhole = Class(NullShell) {
    ...
    AftermathExplosion = function(self, bag, lifetime, wreck)
        ...
        CreateDecal(pos, orientation, 'Crater01_albedo', '', 'Albedo', 20, 20, 1200, 0, self.Army)
        CreateDecal(pos, orientation, 'Crater01_normals', '', 'Normals', 20, 20, 1200, 0, self.Army)
        CreateDecal(pos, orientation, 'nuke_scorch_003_albedo', '', 'Albedo', 20, 30, 1200, 0, self.Army)
