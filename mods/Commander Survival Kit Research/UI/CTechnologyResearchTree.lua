...
if version < 3652 then 
	UIUtil.SetNewButtonTextures(button, up, over, down, dis)
		...
		local T2BTN, T3BTN, ExpBTN
			...
			T2BTNdis = ('/mods/Commander Survival Kit Research/textures/Research Buttons/Cybran/CT2_btn_dis.dds')
			T3BTNdis = ('/mods/Commander Survival Kit Research/textures/Research Buttons/Cybran/CT3_btn_dis.dds')
			ExBTNdis = ('/mods/Commander Survival Kit Research/textures/Research Buttons/Cybran/CEx_btn_dis.dds')
