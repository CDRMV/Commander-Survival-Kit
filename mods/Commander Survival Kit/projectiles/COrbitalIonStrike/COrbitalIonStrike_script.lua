...
AOrbitalLaserStrike = Class(Projectile) {
    ...
    FxTrails = {
	'/mods/Commander Survival Kit/effects/emitters/ion_cannon_fxtrail_01_emit.bp',
	'/mods/Commander Survival Kit/effects/emitters/ion_cannon_fxtrail_02_emit.bp',
	'/mods/Commander Survival Kit/effects/emitters/ion_cannon_fxtrail_03_emit.bp',
	},
    ...
    OnImpact = function(self, impactType, targetEntity)
		...
		if impactType == 'Terrain' then
			...
			CreateEmitterAtEntity( self, -1, Modpath .. 'ion_cloud_01_emit.bp' ):ScaleEmitter(3)
