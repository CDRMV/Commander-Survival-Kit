...
TIFProtoDrillMissile01 = Class(TIFMissileNuke) {
    ...
    OnImpact = function(self, TargetType, TargetEntity)
		...
		local ShieldUnit =CreateUnitHPR('UTX0100', self:GetArmy(), location[1], location[2], location[3], 0, 0, 0)
...
TypeClass = TIFProtoDrillMissile01
