...
CIFMicrowaveLaserPods01 = Class(CDFProtonCannonProjectile) {
    ...
    OnImpact = function(self, TargetType, TargetEntity) 
        ...
        local ChildProjectileBP = '/mods/Commander Survival Kit/projectiles/CIFMicrowaveLaserPods02/CIFMicrowaveLaserPods02_proj.bp'  
...
TypeClass = CIFMicrowaveLaserPods01
