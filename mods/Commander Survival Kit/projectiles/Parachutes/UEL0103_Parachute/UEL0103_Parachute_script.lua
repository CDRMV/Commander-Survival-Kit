...
UEL0103_Parachute = Class(SingleBeamProjectile) {
    ...
    OnCreate = function(self)
		SingleBeamProjectile.OnCreate(self)
			...
			local paratrooper = CreateUnitHPR('UEL0103', self:GetArmy(), location[1], location[2], location[3], 0, 0, 0)
