...
UEL0201_Parachute = Class(SingleBeamProjectile) {
    ...
    OnCreate = function(self)
		...
		SetIgnoreArmyUnitCap(self:GetArmy(), true)
			...
			local paratrooper = CreateUnitHPR('UEL0201', self:GetArmy(), location[1], location[2], location[3], 0, 0, 0)
