...
AStunCloudMissile = Class(SingleBeamProjectile) {
	...
	OnImpact = function(self, TargetType, targetEntity)
		...
		local ShieldUnit =CreateUnitHPR('UAFSSP0200b', self:GetArmy(), location[1], location[2], location[3], 0, 0, 0)
