-- ****************************************************************************
-- **
-- **  File     : /maps/x1ca_coop_005.v0023/X1CA_Coop_005_script.lua
...
local M1Hex5AI = import('/maps/x1ca_coop_005.v0023/X1CA_Coop_005_m1hex5ai.lua')
local M2FletcherAI = import('/maps/x1ca_coop_005.v0023/X1CA_Coop_005_m2fletcherai.lua')
local M2Hex5AI = import('/maps/x1ca_coop_005.v0023/X1CA_Coop_005_m2hex5ai.lua')
local M3QAIAI = import('/maps/x1ca_coop_005.v0023/X1CA_Coop_005_m3qaiai.lua')
local Objectives = import('/lua/ScenarioFramework.lua').Objectives
local OpStrings = import('/maps/x1ca_coop_005.v0023/X1CA_Coop_005_strings.lua')
...
-- Taunt Managers
----------------
local QAITM = TauntManager.CreateTauntManager('QAITM', '/maps/x1ca_coop_005.v0023/X1CA_Coop_005_Strings.lua')
local Hex5TM = TauntManager.CreateTauntManager('Hex5TM', '/maps/x1ca_coop_005.v0023/X1CA_Coop_005_Strings.lua')
local BrackmanTM = TauntManager.CreateTauntManager('BrackmanTM', '/maps/x1ca_coop_005.v0023/X1CA_Coop_005_Strings.lua')
local FletcherTM = TauntManager.CreateTauntManager('FletcherTM', '/maps/x1ca_coop_005.v0023/X1CA_Coop_005_Strings.lua')
...
function M2Counterattack()
    ...
    local num = ScenarioFramework.GetNumOfHumanUnits(categories.STRUCTURE - categories.WALL, false)
    ...
    local num = ScenarioFramework.GetNumOfHumanUnits(((categories.STRUCTURE * categories.DIRECTFIRE) - categories.TECH1) + ((categories.STRUCTURE * categories.ARTILLERY) - categories.TECH1), false)
    ...
    local num = ScenarioFramework.GetNumOfHumanUnits(categories.FACTORY - categories.TECH1, false)
    ...
    local num = ScenarioFramework.GetNumOfHumanUnits((categories.MOBILE * categories.AIR) * (categories.GROUNDATTACK + categories.BOMBER), false)
    ...
    local num = ScenarioFramework.GetNumOfHumanUnits((categories.STRUCTURE * categories.DIRECTFIRE) - categories.TECH1, false)
    ...
    local experimentals = ScenarioFramework.GetListOfHumanUnits(categories.EXPERIMENTAL - categories.AIR, false)
