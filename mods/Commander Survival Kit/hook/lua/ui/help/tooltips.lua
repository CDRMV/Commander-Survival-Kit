...
Tooltips = {
   ...
   MSBtn = {
	...
	construction_tab_t35 = {
        title = "<LOC tooltipCSKUElite>Elite Tech",
        description = "",
    },
    construction_tab_t35_dis = {
        title = "<LOC tooltipCSKUDisElite>Elite Tech",
	...
	construction_tab_t5 = {
        title = "<LOC tooltipCSKUTitan>Titan Tech",
        description = "",
    },
    construction_tab_t5_dis = {
        title = "<LOC tooltipCSKUDisTitan>Titan Tech",
        description = "<LOC tooltipui0437>Unit's tech level is insufficient. Unable to access this technology.",
    },
	construction_tab_t6 = {
        title = "<LOC tooltipCSKUHero>Hero Tech",
        description = "",
    },
    construction_tab_t6_dis = {
        title = "<LOC tooltipCSKUDisHero>Hero Tech",
        description = "<LOC tooltipui0437>Unit's tech level is insufficient. Unable to access this technology.",
    },
