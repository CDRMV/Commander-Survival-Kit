...
function CreateUI()
    ...
    local function CreateSelectionEntry(data)
        ...
        if data.factionIcons then
            ...
            for i, facData in factionData do
                ...
                buttons[index].Height:Set(function() return buttons[index].BitmapHeight() * .5 end)
                buttons[index].Width:Set(function() return buttons[index].BitmapWidth() * .5 end)
                if index == 1 then
        ...
        item.highlightBox.Left:Set(function() return item.Left() + 2 end)
        item.highlightBox.Right:Set(function() return item.Left() + 230 end)
        item.highlightBox.Top:Set(function() return item.Top() + 2 end)
        item.highlightBox.Bottom:Set(function() return item.Bottom() - 2 end)
        item.highlightBox.Depth:Set(function() return item.Depth() - 1 end)
        
        item.highlightIconBox = Bitmap(item.highlight)
        item.highlightIconBox:SetSolidColor('aa7d9d9d')
        item.highlightIconBox.Left:Set(function() return item.Left() + 250 end)
        item.highlightIconBox.Right:Set(function() return item.Right() - 2 end)
        item.highlightIconBox.Top:Set(function() return item.Top() + 2 end)
        item.highlightIconBox.Bottom:Set(function() return item.Bottom() - 2 end)
        item.highlightIconBox.Depth:Set(function() return item.Depth() - 1 end)
        
        item.boxTop = Bitmap(item)
        item.boxTop:SetSolidColor('ff7d9d9d')
        item.boxTop.Left:Set(item.Left)
        item.boxTop.Right:Set(function() return item.Left() + 232 end)
        item.boxTop.Bottom:Set(item.Top)
        item.boxTop.Height:Set(1)
        item.boxTop.Depth:Set(function() return item.Depth() - 1 end)
        
        item.boxBottom = Bitmap(item)
        item.boxBottom:SetSolidColor('ff7d9d9d')
        item.boxBottom.Left:Set(item.Left)
        item.boxBottom.Right:Set(function() return item.Left() + 232 end)
        item.boxBottom.Top:Set(item.Bottom)
        item.boxBottom.Height:Set(1)
        item.boxBottom.Depth:Set(function() return item.Depth() - 1 end)
        
        item.boxLeft = Bitmap(item)
        item.boxLeft:SetSolidColor('ff7d9d9d')
        item.boxLeft.Top:Set(item.boxTop.Top)
        item.boxLeft.Bottom:Set(item.boxBottom.Bottom)
        item.boxLeft.Right:Set(item.boxTop.Left)
        item.boxLeft.Width:Set(1)
        item.boxLeft.Depth:Set(function() return item.Depth() - 1 end)
        
        item.boxRight = Bitmap(item)
        item.boxRight:SetSolidColor('ff7d9d9d')
        item.boxRight.Top:Set(item.boxTop.Top)
        item.boxRight.Bottom:Set(item.boxBottom.Bottom)
        item.boxRight.Left:Set(item.boxTop.Right)
        item.boxRight.Width:Set(1)
        item.boxRight.Depth:Set(function() return item.Depth() - 1 end)
        
        item.boxIconTop = Bitmap(item)
        item.boxIconTop:SetSolidColor('ff7d9d9d')
        item.boxIconTop.Left:Set(function() return item.Left() + 248 end)
        item.boxIconTop.Right:Set(item.Right)
        item.boxIconTop.Bottom:Set(item.Top)
        item.boxIconTop.Height:Set(1)
        item.boxIconTop.Depth:Set(function() return item.Depth() - 1 end)
        
        item.boxIconBottom = Bitmap(item)
        item.boxIconBottom:SetSolidColor('ff7d9d9d')
        item.boxIconBottom.Left:Set(function() return item.Left() + 248 end)
        item.boxIconBottom.Right:Set(item.Right)
        item.boxIconBottom.Top:Set(item.Bottom)
        item.boxIconBottom.Height:Set(1)
        item.boxIconBottom.Depth:Set(function() return item.Depth() - 1 end)
        
        item.boxIconLeft = Bitmap(item)
        item.boxIconLeft:SetSolidColor('ff7d9d9d')
        item.boxIconLeft.Top:Set(item.boxIconTop.Top)
        item.boxIconLeft.Bottom:Set(item.boxIconBottom.Bottom)
        item.boxIconLeft.Right:Set(item.boxIconBottom.Left)
        item.boxIconLeft.Width:Set(1)
        item.boxIconLeft.Depth:Set(function() return item.Depth() - 1 end)
        
        item.boxIconRight = Bitmap(item)
        item.boxIconRight:SetSolidColor('ff7d9d9d')
        item.boxIconRight.Top:Set(item.boxIconTop.Top)
        item.boxIconRight.Bottom:Set(item.boxIconBottom.Bottom)
        item.boxIconRight.Left:Set(item.boxIconBottom.Right)
        item.boxIconRight.Width:Set(1)
    ...
    LOG(enableOutros, " : ", repr(creditsAvailable))
    ...
    GUI.selOpDescription.Top:Set(function() return GUI.briefingBG.Top() + 68 end)
    GUI.selOpDescription.Left:Set(function() return GUI.briefingBG.Left() + 20 end)
    GUI.selOpDescription.Right:Set(function() return GUI.briefingBG.Right() - 50 end)
    GUI.selOpDescription.Bottom:Set(function() return GUI.briefingBG.Bottom() - 30 end)
...
function SelectOperation(opData)
    ...
    if opData.launchType == 'operation' then
        ...
        GUI.selectBtn.OnClick = function(self)
            GUI.parent:Destroy()
            import('/mods/Commander Survival Kit/hook/lua/ui/campaign/operationbriefing.lua').CreateUI(opData.id, opData.briefingData) 
        end
...
function TimelineFMV(toOpSelect)
    ...
    function DoExit(onFMVFinished)
        ...
        if toOpSelect then
            ...
            import('/mods/Commander Survival Kit/hook/lua/ui/campaign/operationbriefing.lua').CreateUI('X1CA_001', opData) 
        end
    end
