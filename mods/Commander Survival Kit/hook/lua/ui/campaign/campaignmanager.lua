...
function LaunchBriefing(nextOpData)
    ...
    if DiskGetFileInfo('/maps/'..opID..'/'..opID..'_operation.lua') then
        ...
        import('/mods/Commander Survival Kit/hook/lua/ui/campaign/operationbriefing.lua').CreateUI(opID, opData.operationData, nextOpData.campaignID, nextOpData.difficulty)
        return true
    end
    return false
end
