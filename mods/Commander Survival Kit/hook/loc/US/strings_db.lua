--ISO_639-1_code=EN
--+------------+--+-------------------------------------------------------------
--¦████████████¦--¦   Commander Survival Kit English strings table
--¦▒▒▒▒▒▒▒▒▒▒▒▒¦--¦   Author: CDRMV
--¦░░░░░░░░░░░░¦--¦   Translator: CDRMV
--+------------+--+-------------------------------------------------------------
...
tooltipCSKLoadTitle="Load"
tooltipCSKLoadDesc="Load the previously saved Configurations"

tooltipCSKDoneTitle="Done"
tooltipCSKDoneDesc="Continue with the Mission and transfer all Configurations to the Code"

tooltipCSKRefManagerTitle="Reinforcement Manager"
tooltipCSKRefManagerDesc="Open/Hide the Layer Button Overview."

tooltipCSKFSManagerTitle="Fire Support Manager"
tooltipCSKFSManagerDesc="Open/Hide the Fire Support Manager."

tooltipCSKLandRefManagerTitle="Land Reinforcement Manager"
tooltipCSKLandRefManagerDesc="Open/Hide the Land Reinforcement Manager."

tooltipCSKAirRefManagerTitle="Air Reinforcement Manager"
tooltipCSKAirRefManagerDesc="Open/Hide the Air Reinforcement Manager."

tooltipCSKNavalRefManagerTitle="Naval Reinforcement Manager"
tooltipCSKNavalRefManagerDesc="Open/Hide the Naval Reinforcement Manager."

tooltipCSKSpaceRefManagerTitle="Space Reinforcement Manager"
tooltipCSKSpaceRefManagerDesc="Open/Hide the Space Reinforcement Manager."

tooltipCSKDesSpaceRefManagerTitle="Space Reinforcement Manager (Not available) "
tooltipCSKDesSpaceRefManagerDesc="Requires the installation & activation of F.B.P. Orbital."

tooltipCSKTechFWTitle="Forward"
tooltipCSKTechFWDesc="Go to the next Tech Level Section Overview."

tooltipCSKTechBBTitle="Back"
tooltipCSKTechBBDesc="Go to the previous Tech Level Section Overview."

tooltipCSKFWTitle="Forward"
tooltipCSKFWDesc="Go to the next Section Overview."

tooltipCSKBBTitle="Back"
 tooltipCSKBBDesc="Go to the previous Section Overview."

tooltipCSKASFWTitle="Forward"
tooltipCSKASFWDesc="Go to the next Air Strike Overview."

tooltipCSKASBBTitle="Back"
tooltipCSKASBBTitle="Go to the previous Air Strike Overview."

tooltipCSKARTFWTitle="Forward"
tooltipCSKARTFWDesc="Go to the next Artillery Overview."

tooltipCSKARTBBTitle="Back"
tooltipCSKARTBBDesc="Go to the previous Artillery Overview."

tooltipCSKMFWTitle="Forward"
tooltipCSKMFWDesc="Go to the next Missile Overview."

tooltipCSKMBBTitle="Back"
tooltipCSKMBBDesc="Go to the previous Missile Overview."

tooltipCSKBFWTitle="Forward"
tooltipCSKBFWDesc="Go to the next Beam Overview."

tooltipCSKBBBTitle="Back"
tooltipCSKBBBDesc="Go to the previous Beam Overview."

tooltipCSKSPFWTitle="Forward"
tooltipCSKSPFWDesc="Go to the next Special Overview."

tooltipCSKSPBBTitle="Back"
tooltipCSKSPBBDesc="Go to the previous Special Overview."

tooltipCSKHelpTitle="Help"
tooltipCSKHelpDesc="Open/Hide the C.S.K. Helpcenter."
...
tooltipCSKHelpPlayTitle="Play"
tooltipCSKHelpPlayDesc="Play the Tutorial Video."


tooltipCSKHelpStopTitle="Stop"
tooltipCSKHelpStopDesc="Stop the Tutorial Video."

tooltipCSKTacPointStoreTitle="Tactical Point Storage"
tooltipCSKTacPointStoreDesc="Current and Maximum Tactical Point Values"

tooltipCSKRefPointStoreTitle="Reinforcement Point Storage"
tooltipCSKRefPointStoreDesc="Current and Maximum Reinforcement Point Values"

tooltipCSKTacPointIncomeTitle="Tactical Point Income"
tooltipCSKTacPointIncomeDesc="Display of generating Tactical Points per specific amount of Seconds"

tooltipCSKRefPointIncomeTitle="Reinforcement Point Income"
tooltipCSKRefPointIncomeDesc="Display of generating Reinforcement Points per specific amount of Seconds"

tooltipCSKSupportPanelTitle="[Hide/Show] Support Bar"
...
RefManager="Reinforcement Manager"
LandRefManager="Land Reinforcement Manager"
AirRefManager="Air Reinforcement Manager"
NavalRefManager="Naval Reinforcement Manager"
SpaceRefManager="Space Reinforcement Manager"


FSManager="Fire Support Manager"
DropDef="Drop Defenses"
...
Gen15Min="Generation starts in 15 Minutes"
Gen20Min="Generation starts in 20 Minutes"
Gen25Min="Generation starts in 25 Minutes"
Gen30Min="Generation starts in 30 Minutes"
Gen35Min="Generation starts in 35 Minutes"
Gen40Min="Generation starts in 40 Minutes"
Gen45Min="Generation starts in 45 Minutes"
Gen50Min="Generation starts in 50 Minutes"
Gen55Min="Generation starts in 55 Minutes"
Gen60Min="Generation starts in 60 Minutes"

NoPoints="No available Points"
HasPoints="Points available"
AwaitingOrders="Awaiting Orders"
GenInProgress="Generation in Progress"
NoEnoughPoints="Not enough Points"
GenHasStop="Generation has been stopped"
PointLimit="Point Limit reached"

Info="Info"
NoUnitName="This Unit doesn't has a Name"
NoUnitDesc="This Unit doesn't has a Description"
NoPrice="No Price has been found"
LandOnly="Land only"
Amph="Land and Water"
Price="Price: "
DroppableAbove="       Droppable above: "
CallableAbove="       Callable above: "


DDNorthDesc="Sets the Spawn Origin for the Delivery Cargo Gunships of all callable Drop Defenses to the North Side of the Map."
DDEastDesc="Sets the Spawn Origin for the Delivery Cargo Gunships of all callable Drop Defenses to the East Side of the Map."
DDSouthDesc="Sets the Spawn Origin for the Delivery Cargo Gunships of all callable Drop Defenses to the South Side of the Map."
DDWestDesc="Sets the Spawn Origin for the Delivery Cargo Gunships of all callable Drop Defenses to the West Side of the Map."
DDRandomDesc="Let the Delivery Cargo Gunships of all callable Drop Defenses Spawn from any Side of the Map randomly."

ASNorthDesc="Sets the Spawn Origin of all callable Air Strikes to the North Side of the Map."
ASEastDesc="Sets the Spawn Origin of all callable Air Strikes to the East Side of the Map."
ASSouthDesc="Sets the Spawn Origin of callable all Air Strikes to the South Side of the Map."
ASWestDesc="Sets the Spawn Origin of callable all Air Strikes to the West Side of the Map."
ASRandomDesc="Let all callable Air Strikes Spawn from any Side of the Map randomly."

LRefNorthDesc="Sets the Spawn Origin for the Delivery Cargo Gunships and Cargo Planes of all callable Land Reinforcements to the North Side of the Map."
LRefEastDesc="Sets the Spawn Origin for the Delivery Cargo Gunships and Cargo Planes of all callable Land Reinforcements to the East Side of the Map."
LRefSouthDesc="Sets the Spawn Origin for the Delivery Cargo Gunships and Cargo Planes of all callable Land Reinforcements to the South Side of the Map."
LRefWestDesc="Sets the Spawn Origin for the Delivery Cargo Gunships and Cargo Planes of all callable Land Reinforcements to the West Side of the Map."
LRefRandomDesc="Let all Delivery Cargo Gunships and Cargo Planes of all callable Land Reinforcements Spawn from any Side of the Map randomly."

ARefNorthDesc="Sets the Spawn Origin of all callable Air Reinforcements to the North Side of the Map."
ARefEastDesc="Sets the Spawn Origin of all callable Air Reinforcements to the East Side of the Map."
ARefSouthDesc="Sets the Spawn Origin of all callable Air Reinforcements to the South Side of the Map."
ARefWestDesc="Sets the Spawn Origin of all callable Air Reinforcements to the West Side of the Map."
ARefRandomDesc="Let all callable Air Reinforcements Spawn from any Side of the Map randomly."

NRefNorthDesc="Sets the Spawn Origin for the Delivery Cargo Gunships of all callable Naval Reinforcements to the North Side of the Map."
NRefEastDesc="Sets the Spawn Origin for the Delivery Cargo Gunships of all callable Naval Reinforcements to the East Side of the Map."
NRefSouthDesc="Sets the Spawn Origin for the Delivery Cargo Gunships of all callable Naval Reinforcements to the South Side of the Map."
NRefWestDesc="Sets the Spawn Origin for the Delivery Cargo Gunships of all callable Naval Reinforcements to the West Side of the Map."
NRefRandomDesc="Let all Delivery Cargo Gunships of all callable Naval Reinforcements Spawn from any Side of the Map randomly."


SetASOrigin="Set the Spawn Origin of all callable Air Strikes."
SetDOrigin="Set the Spawn Origin of the Delivery Units for all callable Drop Defenses."
SetLRefOrigin="Set the Spawn Origin of the Delivery Units for all callable Land Reinforcements." 
SetARefOrigin="Set the Spawn Origin of all callable Air Reinforcements."
SetNRefOrigin="Set the Spawn Origin of the Delivery Units for all callable Naval Reinforcements."

Reinforcements="Reinforcements (Tutorials)"
FireSupport="Fire Support (Tutorials)"
DropDefenses="Drop Defenses (Tutorials)"
