...
UAFSAS02 = Class(AAirUnit) {
    Weapons = {
        Bomb = Class(AIFBombGravitonWeapon) {
						IdleState = State(AIFBombGravitonWeapon.IdleState) {
                OnGotTarget = function(self)
				     AIFBombGravitonWeapon.IdleState.OnGotTarget(self)
                end,            
		...
		RackSalvoFireReadyState = State(AIFBombGravitonWeapon.RackSalvoFireReadyState) {
                OnFire = function(self)
                        AIFBombGravitonWeapon.RackSalvoFireReadyState.OnFire(self)
