...
XSFSSP0100b = Class(StructureUnit) {
    ...
    OnStopBeingBuilt = function(self,builder,layer)
        StructureUnit.OnStopBeingBuilt(self,builder,layer)
			...
			self.Effect2 = CreateAttachedEmitter(self,0,self:GetArmy(), Modpath .. 'seraphim_ring_01_emit.bp'):ScaleEmitter(18.0):OffsetEmitter(0,0.5,0)
			...
			self.Effect3 = CreateAttachedEmitter(self,0,self:GetArmy(), Modpath .. 'regen_aura_01_emit.bp'):ScaleEmitter(3.0)
            self.Trash:Add(self.Effect3)
			self.Effect4 = CreateAttachedEmitter(self,0,self:GetArmy(), Modpath .. 'regen_aura_02_emit.bp'):ScaleEmitter(3.0)
            self.Trash:Add(self.Effect4)
			self.Effect5 = CreateAttachedEmitter(self,0,self:GetArmy(), Modpath .. 'regen_aura_03_emit.bp'):ScaleEmitter(3.0)
