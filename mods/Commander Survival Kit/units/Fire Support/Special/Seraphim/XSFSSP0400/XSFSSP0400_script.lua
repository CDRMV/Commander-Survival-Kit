...
XSFSSP0400 = Class(SAirUnit) {
    OnCreate = function(self)
        ...
        ForkThread( function()
						...
						self.Effect1 = CreateAttachedEmitter(self,0,self:GetArmy(), ModeffectPath .. 'sera_teleport_01_emit.bp'):ScaleEmitter(0.55)
						self.Trash:Add(self.Effect1)
						self.Effect2 = CreateAttachedEmitter(self,0,self:GetArmy(), ModeffectPath .. 'sera_teleport_02_emit.bp'):ScaleEmitter(0.55)
						self.Trash:Add(self.Effect2)
						self.Effect3 = CreateAttachedEmitter(self,0,self:GetArmy(), ModeffectPath .. 'sera_teleport_03_emit.bp'):ScaleEmitter(0.65)
						self.Trash:Add(self.Effect3)

						WaitSeconds(10)
                        CreateLightParticle( self, 0, self:GetArmy(), 3, 7, 'glow_03', 'ramp_white_01' ) 
						self.Effect4 = CreateAttachedEmitter(self,0,self:GetArmy(), ModeffectPath .. 'sera_TeleportRing_01_emit.bp'):ScaleEmitter(0.55)
						self.Trash:Add(self.Effect4)
						self.Effect6 = CreateAttachedEmitter(self,0,self:GetArmy(), ModeffectPath .. 'sera_teleport_03_emit.bp'):ScaleEmitter(0.65)
						self.Trash:Add(self.Effect6)
						self.Effect7 = CreateAttachedEmitter(self,0,self:GetArmy(), ModeffectPath .. 'sera_teleport_04_emit.bp'):ScaleEmitter(0.75)
						...
						self.Sphere:SetDrawScale(2.0)
						self.Sphere:SetVizToAllies('Intel')
						self.Sphere:SetVizToNeutrals('Intel')
						self.Sphere:SetVizToEnemies('Intel')
						self.Effect1 = CreateAttachedEmitter(self,0,self:GetArmy(), ModeffectPath .. 'sera_anomalieeffect_01_emit.bp'):ScaleEmitter(15.0)
						self.Trash:Add(self.Effect1)
						self.Effect2 = CreateAttachedEmitter(self,0,self:GetArmy(), ModeffectPath .. 'sera_anomalieeffect_02_emit.bp'):ScaleEmitter(15.0)
						self.Trash:Add(self.Effect2)
						while true do	
	...
	CaptureThread = function(self)
			...
			self.UnitEffect1 = CreateAttachedEmitter(enemyunits[1],0,self:GetArmy(), ModeffectPath .. 'sera_anomalieeffect_03_emit.bp'):ScaleEmitter(1.0):OffsetEmitter(0, 0.1, 0)
			self.Trash:Add(self.UnitEffect1)
			self.UnitEffect2 = CreateAttachedEmitter(enemyunits[1],0,self:GetArmy(), ModeffectPath .. 'sera_anomalieeffect_04_emit.bp'):ScaleEmitter(1.0):OffsetEmitter(0, 0.1, 0)
