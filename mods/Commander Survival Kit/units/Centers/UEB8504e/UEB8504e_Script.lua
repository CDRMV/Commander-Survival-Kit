...
UEB8504e = Class(StructureUnit) {

    OnStopBeingBuilt = function(self,builder,layer)
        StructureUnit.OnStopBeingBuilt(self,builder,layer)
		self.Entity = import('/lua/sim/Entity.lua').Entity({Owner = self,})
        self.Entity:AttachBoneTo( -1, self, 'Spinner' )
        self.Entity:SetMesh('/mods/Commander Survival Kit/effects/entities/Symbols/UEF/Tactical/Tactical_mesh')
		...
		Sync.TacticalPointStorageCountLVL5 = true
	...
	OnKilled = function(self, instigator, type, overkillRatio)
		self.Entity:Destroy()
		Sync.TacticalPointStorageCountLVL5 = false
