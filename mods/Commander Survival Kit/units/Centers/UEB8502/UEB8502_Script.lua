...
UEB8502 = Class(StructureUnit) {
    ...
    OnStopBeingBuilt = function(self,builder,layer)
        ...
        self.Entity2:SetMesh('/mods/Commander Survival Kit/effects/entities/Symbols/UEF/Tactical/Tactical_mesh')
        ...
        self.Entity3:SetMesh('/mods/Commander Survival Kit/effects/entities/Symbols/UEF/Reinforcement/Reinforcement_mesh')
        ...
        self.Entity4:SetMesh('/mods/Commander Survival Kit/effects/entities/Symbols/UEF/Tactical/Tactical_mesh')
