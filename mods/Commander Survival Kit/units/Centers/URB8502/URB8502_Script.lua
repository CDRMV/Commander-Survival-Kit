...
URB8502 = Class(StructureUnit) {

    OnStopBeingBuilt = function(self,builder,layer)
        StructureUnit.OnStopBeingBuilt(self,builder,layer)
		self.Entity = import('/lua/sim/Entity.lua').Entity({Owner = self,})
        self.Entity:AttachBoneTo( -1, self, 'L_Spinner01' )
        self.Entity:SetMesh('/mods/Commander Survival Kit/effects/entities/Symbols/Cybran/Reinforcement/Reinforcement_mesh')
        ...
        self.Entity2:SetMesh('/mods/Commander Survival Kit/effects/entities/Symbols/Cybran/Tactical/Tactical_mesh')
        ...
        self.Entity3:SetMesh('/mods/Commander Survival Kit/effects/entities/Symbols/Cybran/Reinforcement/Reinforcement_mesh')
        ...
        self.Entity4:SetMesh('/mods/Commander Survival Kit/effects/entities/Symbols/Cybran/Tactical/Tactical_mesh')
