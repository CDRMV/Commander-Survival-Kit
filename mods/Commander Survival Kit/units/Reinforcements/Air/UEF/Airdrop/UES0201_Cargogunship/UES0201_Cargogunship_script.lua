...
UES0201_Cargogunship = Class(TAirUnit) {
...
self:SetSpeedMult(0.7)  
		...
		self.Cargo = CreateUnitHPR('UES0201', self:GetArmy(), position.x, position.y, position.z, 0, 0, 0)
		...
		table.insert(TransportBeamEffectsBag,AttachBeamEntityToEntity(self, 'Tractor_Emitter_Effect', self.Cargo, 'Back_Turret01', self:GetArmy(), Effects ))
...
TypeClass = UES0201_Cargogunship