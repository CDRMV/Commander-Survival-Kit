...
UES0304_Cargogunship = Class(TAirUnit) {
...
self:SetSpeedMult(0.7)  
		...
		self.Cargo = CreateUnitHPR('UES0304', self:GetArmy(), position.x, position.y, position.z, 0, 0, 0)
		self.Cargo:AttachBoneTo(0, self, 'Attachpoint_Lrg_02')
		SetIgnoreArmyUnitCap(self:GetArmy(), false)
		self.Cargo:DestroyIdleEffects()
        self.EngineManipulators = {}
		
		table.insert(TransportBeamEffectsBag,AttachBeamEntityToEntity(self, 'Tractor_Emitter_Effect', self.Cargo, 'Center_Projectile01', self:GetArmy(), Effects ))
		...
		table.insert(TransportBeamEffectsBag,AttachBeamEntityToEntity(self, 'Tractor_Emitter_Effect', self.Cargo, 'Center_Projectile02', self:GetArmy(), Effects ))
...
TypeClass = UES0304_Cargogunship