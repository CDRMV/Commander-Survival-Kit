...
XES0102_Cargogunship = Class(TAirUnit) {
...
self:SetSpeedMult(1.0)  
		...
		self.Cargo = CreateUnitHPR('XES0102', self:GetArmy(), position.x, position.y, position.z, 0, 0, 0)
		self.Cargo:AttachBoneTo(0, self, 'Attachpoint_Lrg_02')
		SetIgnoreArmyUnitCap(self:GetArmy(), false)
		self.Cargo:DestroyIdleEffects()
        self.EngineManipulators = {}
		
		table.insert(TransportBeamEffectsBag,AttachBeamEntityToEntity(self, 'Tractor_Emitter_Effect', self.Cargo, 'Projectile01', self:GetArmy(), Effects ))
...
TypeClass = XES0102_Cargogunship