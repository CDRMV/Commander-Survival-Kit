...
XES0307_Cargogunship_Squadron = Class(TAirUnit) {
...
self:SetSpeedMult(0.5) 
		...
		table.insert(TransportBeamEffectsBag,AttachBeamEntityToEntity(self.Gunship02, 'Tractor_Emitter_Effect', self.Cargo, 'Front_Turret02', self:GetArmy(), Effects ))
		table.insert(TransportBeamEffectsBag,AttachBeamEntityToEntity(self.Gunship02, 'Tractor_Emitter_Effect', self.Cargo, 'Back_Turret', self:GetArmy(), Effects ))
		table.insert(TransportBeamEffectsBag,AttachBeamEntityToEntity(self.Gunship03, 'Tractor_Emitter_Effect', self.Cargo, 'Front_Turret02', self:GetArmy(), Effects ))
		table.insert(TransportBeamEffectsBag,AttachBeamEntityToEntity(self.Gunship03, 'Tractor_Emitter_Effect', self.Cargo, 'Back_Turret', self:GetArmy(), Effects ))
...
TypeClass = XES0307_Cargogunship_Squadron