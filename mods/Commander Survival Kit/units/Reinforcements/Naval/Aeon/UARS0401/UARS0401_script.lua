...
UARS0401 = Class(AAirFactoryUnit) {
    ...
    OnStopBeingBuilt = function(self, builder, layer)
        ...
        ForkThread( function()
						...
						WaitSeconds(4)
						CreateLightParticle( self, 'Effect', self:GetArmy(), 18, 7, 'glow_03', 'ramp_white_01' ) 
						self.Effect1 = CreateAttachedEmitter(self,'Effect',self:GetArmy(), ModeffectPath .. 'aeon_teleport_01_emit.bp'):ScaleEmitter(6.95)
						self.Trash:Add(self.Effect1)
						self.Effect2 = CreateAttachedEmitter(self,'Effect',self:GetArmy(), ModeffectPath .. 'aeon_teleport_02_emit.bp'):ScaleEmitter(6.85)
						self.Trash:Add(self.Effect2)
						self.Effect3 = CreateAttachedEmitter(self,'Effect',self:GetArmy(), ModeffectPath .. 'aeon_teleport_03_emit.bp'):ScaleEmitter(6.95)
						self.Trash:Add(self.Effect3)

						WaitSeconds(25)
                        CreateLightParticle( self, 'Effect', self:GetArmy(), 12, 7, 'glow_03', 'ramp_white_01' ) 
						self:HideBone( 'Ring', true )
						CreateLightParticle( self, 'Effect', self:GetArmy(), 12, 7, 'glow_03', 'ramp_white_01' ) 
						self.Effect4 = CreateAttachedEmitter(self,'Effect',self:GetArmy(), ModeffectPath .. 'aeon_TeleportRing_01_emit.bp'):ScaleEmitter(6.75)
						self.Trash:Add(self.Effect4)
						self.Effect6 = CreateAttachedEmitter(self,'Effect',self:GetArmy(), ModeffectPath .. 'aeon_teleport_03_emit.bp'):ScaleEmitter(6.85)
						self.Trash:Add(self.Effect6)
						self.Effect7 = CreateAttachedEmitter(self,'Effect',self:GetArmy(), ModeffectPath .. 'aeon_teleport_04_emit.bp'):ScaleEmitter(6.95)
