	...
	self:HideBone('UEFSSP0100b', true)
		...
		self:ForkThread(
            function()
				...
				entity:SetMesh('/mods/Commander Survival Kit/meshes/Cybran/AircraftCarrier_Mesh')
				entity:SetDrawScale(0.1)
				...
				entity:SetVizToEnemies'Intel'
					...
					if interval == 20 then 
						self:Destroy()
						entity:Destroy()
						local ShieldUnit =CreateUnitHPR('URS0303', self:GetArmy(), location[1], location[2], location[3], 0, 0, 0)
					end
