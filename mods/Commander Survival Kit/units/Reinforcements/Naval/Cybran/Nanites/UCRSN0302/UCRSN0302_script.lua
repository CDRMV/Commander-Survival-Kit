    ...
    OnStopBeingBuilt = function(self,builder,layer)
		...
		self:ForkThread(
            function()
				...
				entity:SetMesh('/mods/Commander Survival Kit/meshes/Cybran/Battleship_Mesh')
				...
				entity:SetVizToEnemies'Intel'
					...
					if interval == 20 then 
						self:Destroy()
						entity:Destroy()
						local ShieldUnit =CreateUnitHPR('URS0302', self:GetArmy(), location[1], location[2], location[3], 0, 0, 0)
					end
