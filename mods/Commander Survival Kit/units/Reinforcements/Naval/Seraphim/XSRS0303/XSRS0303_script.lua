...
XSRS0303 = Class(SAirFactoryUnit) {
    ...
    OnStopBeingBuilt = function(self, builder, layer)
        ...
        ForkThread( function()
						WaitSeconds(1)
						CreateLightParticle( self, 'Effect', self:GetArmy(), 8, 7, 'glow_03', 'ramp_ser_01' ) 
                        ...
                        self:Destroy()
						CreateLightParticle( self, 'Effect', self:GetArmy(), 18, 7, 'glow_03', 'ramp_ser_01' ) 
