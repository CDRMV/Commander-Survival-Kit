    ...
    OnStopBeingBuilt = function(self,builder,layer)
		...
		self:ForkThread(
            function()
				...
				entity:SetMesh('/mods/Commander Survival Kit/meshes/Cybran/Monkeylord_Mesh')
				entity:SetDrawScale(0.0725)
				...
				entity:SetVizToEnemies'Intel'
					...
					if interval == 30 then 
						self:Destroy()
						entity:Destroy()
						local ShieldUnit =CreateUnitHPR('URL0402', self:GetArmy(), location[1], location[2], location[3], 0, 0, 0)
					end
