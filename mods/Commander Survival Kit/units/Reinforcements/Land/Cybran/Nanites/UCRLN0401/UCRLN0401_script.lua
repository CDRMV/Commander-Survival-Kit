    ...
    OnStopBeingBuilt = function(self,builder,layer)
		...
		self:ForkThread(
            function()
				...
				entity:SetMesh('/mods/Commander Survival Kit/meshes/Cybran/Scathis_Mesh')
				...
				entity:SetVizToEnemies'Intel'
					...
					if interval == 30 then 
						self:Destroy()
						entity:Destroy()
						local ShieldUnit =CreateUnitHPR('URL0401b', self:GetArmy(), location[1], location[2], location[3], 0, 0, 0)
					end
