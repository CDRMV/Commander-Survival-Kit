...
XSA0104b = Class(SAirUnit) {
	...
	OnStopBeingBuilt = function(self,builder,layer)
		...
		self.Station08:AttachBoneTo('AttachPoint', self, 'Left_Attachpoint04')
		self.Station09 = CreateUnitHPR('xsl0201', self:GetArmy(), position.x, position.y, position.z, 0, 0, 0)
		self.Station09:AttachBoneTo('AttachPoint', self, 'Left_Attachpoint05')
		self.Station10 = CreateUnitHPR('xsl0201', self:GetArmy(), position.x, position.y, position.z, 0, 0, 0)
		self.Station10:AttachBoneTo('AttachPoint', self, 'Left_Attachpoint06')
		self.Station08 = CreateUnitHPR('xsl0201', self:GetArmy(), position.x, position.y, position.z, 0, 0, 0)
		self.Station08:AttachBoneTo('AttachPoint', self, 'Left_Attachpoint07')
		self.Station09 = CreateUnitHPR('xsl0201', self:GetArmy(), position.x, position.y, position.z, 0, 0, 0)
		self.Station09:AttachBoneTo('AttachPoint', self, 'Left_Attachpoint08')
		self.Station10 = CreateUnitHPR('xsl0103', self:GetArmy(), position.x, position.y, position.z, 0, 0, 0)
		self.Station10:AttachBoneTo('AttachPoint', self, 'Right_Attachpoint01')
		self.Station08 = CreateUnitHPR('xsl0103', self:GetArmy(), position.x, position.y, position.z, 0, 0, 0)
		self.Station08:AttachBoneTo('AttachPoint', self, 'Right_Attachpoint02')
		self.Station09 = CreateUnitHPR('xsl0103', self:GetArmy(), position.x, position.y, position.z, 0, 0, 0)
		self.Station09:AttachBoneTo('AttachPoint', self, 'Right_Attachpoint03')
		self.Station10 = CreateUnitHPR('xsl0103', self:GetArmy(), position.x, position.y, position.z, 0, 0, 0)
		self.Station10:AttachBoneTo('AttachPoint', self, 'Right_Attachpoint04')
		self.Station08 = CreateUnitHPR('xsl0104', self:GetArmy(), position.x, position.y, position.z, 0, 0, 0)
		self.Station08:AttachBoneTo('AttachPoint', self, 'Right_Attachpoint05')
		self.Station09 = CreateUnitHPR('xsl0104', self:GetArmy(), position.x, position.y, position.z, 0, 0, 0)
		self.Station09:AttachBoneTo('AttachPoint', self, 'Right_Attachpoint06')
		self.Station10 = CreateUnitHPR('xsl0104', self:GetArmy(), position.x, position.y, position.z, 0, 0, 0)
		self.Station10:AttachBoneTo('AttachPoint', self, 'Right_Attachpoint07')
		self.Station08 = CreateUnitHPR('xsl0104', self:GetArmy(), position.x, position.y, position.z, 0, 0, 0)
		self.Station08:AttachBoneTo('AttachPoint', self, 'Right_Attachpoint08')
