...
XSB8802 = Class(SWalkingLandUnit) {
	...
	OnStopBeingBuilt = function(self,builder,layer)
		...
		Dummy = '/mods/Commander Survival Kit/projectiles/Asteroid/Mesh/Asteroid_mesh',
        self.Dummy:AttachBoneTo( -1, self, 'Body' )
		...
		self.ArrivalEffect1 = CreateAttachedEmitter(self.Dummy,0,self:GetArmy(), '/effects/emitters/nuke_munition_launch_trail_04_emit.bp'):ScaleEmitter(4):OffsetEmitter(0,-1,0):SetEmitterParam('LIFETIME', -1):SetEmitterParam('REPEATTIME', -1)
		self.ArrivalEffect2 = CreateAttachedEmitter(self.Dummy,0,self:GetArmy(), '/effects/emitters/nuke_munition_launch_trail_06_emit.bp'):ScaleEmitter(4):OffsetEmitter(0,-1,0):SetEmitterParam('LIFETIME', -1):SetEmitterParam('REPEATTIME', -1)
		self.ArrivalEffect3 = CreateAttachedEmitter(self.Dummy,0,self:GetArmy(), '/mods/Commander Survival Kit/effects/emitters/fire_trail_08_emit.bp'):ScaleEmitter(4):OffsetEmitter(0,-1,0):SetEmitterParam('LIFETIME', -1):SetEmitterParam('REPEATTIME', -1)
		self:HideBone( 'Armor', true )
		self:HideBone( 'Armor', true )
