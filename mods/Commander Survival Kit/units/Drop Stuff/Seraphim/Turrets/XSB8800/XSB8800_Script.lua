...
XSB8800 = Class(SWalkingLandUnit) {
	...
	OnStopBeingBuilt = function(self,builder,layer)
		...
		self.ArrivalEffect3 = CreateAttachedEmitter(self.Dummy,0,self:GetArmy(), '/mods/Commander Survival Kit/effects/emitters/fire_trail_08_emit.bp'):ScaleEmitter(4):OffsetEmitter(0,-1,0)
		self:HideBone( 'Armor', true )
