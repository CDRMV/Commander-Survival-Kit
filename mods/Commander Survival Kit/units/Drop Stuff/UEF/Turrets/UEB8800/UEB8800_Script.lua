...
UEB8800 = Class(TLandUnit) {
    ...
    OnCreate = function(self)
		...
		local wep1 = self:GetWeaponByLabel('Two_GatlingCannons')
        wep1:SetEnabled(false)
		local wep2 = self:GetWeaponByLabel('Two_Gauss')
        wep2:SetEnabled(false)
		local wep3 = self:GetWeaponByLabel('Gauss')
        wep3:SetEnabled(false)
		local wep4 = self:GetWeaponByLabel('GatlingCannon')
        wep4:SetEnabled(false)
		local wep5 = self:GetWeaponByLabel('MissileRack01')
        wep5:SetEnabled(false)
		local wep6 = self:GetWeaponByLabel('MachineGun')
	...
	CreateEnhancement = function(self, enh)
		...
		local wep = self:GetWeaponByLabel('MachineGun')
        wep:SetEnabled(false)
		self:HideBone('SAMMissileLauncher', true)
		self:HideBone('SingleBarrel', true)
		self:HideBone('SingleMachineGun', true)
		...
		local wep = self:GetWeaponByLabel('Gauss')
        wep:SetEnabled(false)
		self:HideBone('SAMMissileLauncher', true)
		self:HideBone('SingleBarrel', true)
		self:HideBone('SingleMachineGun', true)
		...
		local wep = self:GetWeaponByLabel('Two_Gauss')
        wep:SetEnabled(false)
		self:HideBone('SAMMissileLauncher', true)
		self:HideBone('SingleBarrel', true)
		self:HideBone('SingleMachineGun', true)
		...
		local wep = self:GetWeaponByLabel('Two_GatlingCannons')
        wep:SetEnabled(false)
		self:HideBone('SAMMissileLauncher', true)
		self:HideBone('SingleBarrel', true)
		self:HideBone('SingleMachineGun', true)
