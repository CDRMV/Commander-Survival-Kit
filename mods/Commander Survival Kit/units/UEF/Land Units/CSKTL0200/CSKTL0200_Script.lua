...
CSKTL0200 = Class(TLandUnit) {
	...
	OnScriptBitSet = function(self, bit)
		...
		if bit == 0 then 
		local Dooropen = CreateAnimator(self):PlayAnim('/mods/Commander Survival Kit/units/UEF/Land Units/CSKTL0200/CSKTL0200_DoorOpen.sca'):SetRate(1)
		...
		Dooropen:Destroy()
		local Doorclosing = CreateAnimator(self):PlayAnim('/mods/Commander Survival Kit/units/UEF/Land Units/CSKTL0200/CSKTL0200_DoorClosing.sca'):SetRate(1)		
		else	
		end	
        if bit == 1 then 
		local Dooropen = CreateAnimator(self):PlayAnim('/mods/Commander Survival Kit/units/UEF/Land Units/CSKTL0200/CSKTL0200_DoorOpen.sca'):SetRate(1)
