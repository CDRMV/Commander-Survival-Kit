...
UES0304Dropcontainer = Class(SingleBeamProjectile) {
	...
	OnImpact = function(self, TargetType, targetEntity)
		...
		local ShieldUnit =CreateUnitHPR('DCES0304', self:GetArmy(), location[1], location[2], location[3], 0, 0, 0)
		end
	end,
}


TypeClass = UES0304Dropcontainer