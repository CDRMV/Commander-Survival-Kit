...
UES0202Dropcontainer = Class(SingleBeamProjectile) {
	...
	OnImpact = function(self, TargetType, targetEntity)
		...
		local ShieldUnit =CreateUnitHPR('DCES0202', self:GetArmy(), location[1], location[2], location[3], 0, 0, 0)
		end
	end,
}


TypeClass = UES0202Dropcontainer