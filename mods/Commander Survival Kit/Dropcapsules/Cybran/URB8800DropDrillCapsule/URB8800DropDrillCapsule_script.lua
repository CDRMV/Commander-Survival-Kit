...
URB8800DropDrillCapsule = Class(CLOATacticalMissileProjectile) {
   ...
   OnCreate = function(self)
	...
	OnImpact = function(self, TargetType, targetEntity)
		...
		local ShieldUnit =CreateUnitHPR('DCRB8800', self:GetArmy(), location[1], location[2], location[3], 0, 0, 0)
...
TypeClass = URB8800DropDrillCapsule