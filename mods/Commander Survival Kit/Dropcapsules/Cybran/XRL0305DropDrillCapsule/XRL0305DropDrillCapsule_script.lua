...
XRL0305DropDrillCapsule = Class(CLOATacticalMissileProjectile) {
	...
	OnImpact = function(self, TargetType, targetEntity)
		...
		local ShieldUnit =CreateUnitHPR('DCRL0305', self:GetArmy(), location[1], location[2], location[3], 0, 0, 0)
		
		else
		-- This is an Amphibical Unit, which can walk at the Seabed as well.
		-- The Check is irrelevant in General but just to make sure.
		local ShieldUnit =CreateUnitHPR('DCRL0305', self:GetArmy(), location[1], location[2], location[3], 0, 0, 0)
		end
...
TypeClass = XRL0305DropDrillCapsule