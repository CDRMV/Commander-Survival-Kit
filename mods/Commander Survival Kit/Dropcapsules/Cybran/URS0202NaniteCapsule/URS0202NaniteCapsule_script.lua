...
URS0202NaniteCapsule = Class(SinglePolyTrailProjectile) {
	...
	OnImpact = function(self, TargetType, targetEntity)
		...
		local ShieldUnit =CreateUnitHPR('UCRSN0202', self:GetArmy(), location[1], location[2], location[3], 0, 0, 0)
		end
	end,

}

TypeClass = URS0202NaniteCapsule