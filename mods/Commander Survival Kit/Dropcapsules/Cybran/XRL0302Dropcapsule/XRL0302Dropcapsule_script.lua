...
XRL0302Dropcapsule = Class(CLOATacticalMissileProjectile) {
	...
	OnImpact = function(self, TargetType, targetEntity)
		...
		local ShieldUnit =CreateUnitHPR('XRL0302', self:GetArmy(), location[1], location[2], location[3], 0, 0, 0)
	end,
}

TypeClass = XRL0302Dropcapsule