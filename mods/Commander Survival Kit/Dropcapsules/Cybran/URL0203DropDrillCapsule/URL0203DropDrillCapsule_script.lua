...
URL0203DropDrillCapsule = Class(CLOATacticalMissileProjectile) {
	...
	OnImpact = function(self, TargetType, targetEntity)
		...
		local ShieldUnit =CreateUnitHPR('DCRL0203', self:GetArmy(), location[1], location[2], location[3], 0, 0, 0)
		
		else
		-- This is an Amphibical Unit, which drives at the Seabed as well.
...
TypeClass = URL0203DropDrillCapsule