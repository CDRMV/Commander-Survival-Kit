...
URL0401NaniteCapsule = Class(SinglePolyTrailProjectile) {
	...
	OnImpact = function(self, TargetType, targetEntity)
		...
		local ShieldUnit = CreateUnitHPR('UCRLN0401', self:GetArmy(), location[1], location[2], location[3], 0, 0, 0)
		else
...
TypeClass = URL0401NaniteCapsule