...
LayoutHelpers.AtCenterIn(Text8, gameList3, 0, -252)
LayoutHelpers.AtCenterIn(Text9, gameList, 60, -198)
LayoutHelpers.AtCenterIn(Text10, gameList, 120, -200)
LayoutHelpers.AtCenterIn(Text11, gameList, 150, -200)
LayoutHelpers.AtCenterIn(Text12, gameList3, 30, -256)
LayoutHelpers.AtCenterIn(Text13, gameList3, 60, -227)
LayoutHelpers.AtCenterIn(Text14, gameList3, 90, -233)
LayoutHelpers.AtCenterIn(Text15, gameList3, 120, -250)
LayoutHelpers.AtCenterIn(Text16, gameList2, -60, -255)
LayoutHelpers.AtCenterIn(Text17, gameList2, -30, -235)
LayoutHelpers.AtCenterIn(Text18, gameList2, 0, -242)
