...
SmallDimensional = Class(NullShell) {
    ...
    OnCreate = function(self)
        ...
        if pos[2] < (self.surfaceY + 2) then
            pos[2] = self.surfaceY + 2
            Warp( self, pos )
        end
	...
	SecondaryExplosion = function(self, bag, lifetime, wreck)
		...
		local ShieldUnit =CreateUnitHPR('XSFSSP0100c', self:GetArmy(), location[1], location[2], location[3], 0, 0, 0)
