AIOpts = {
    {
        ...
        values = {
            ...
            {
                text = "<LOC 1h5Min>1 Hour 5 Minutes",
                help = "<LOC 1h5MinDesc>Set the Wait Time to 1 Hour 5 Minutes",
                key = 3900,
            },	
            {
                text = "<LOC 1h10Min>1 Hour 10 Minutes",
                help = "<LOC 1h10MinDesc>Set the Wait Time to 1 Hour 10 Minutes",
                key = 4200,
            },	
            {
                text = "<LOC 1h15Min>1 Hour 15 Minutes",
                help = "<LOC 1h15MinDesc>Set the Wait Time to 1 Hour 15 Minutes",
                key = 4500,
            },
            {
                text = "<LOC 1h20Min>1 Hour 20 Minutes",
                help = "<LOC 1h20MinDesc>Set the Wait Time to 1 Hour 20 Minutes",
                key = 4800,
            },	
            {
                text = "<LOC 1h25Min>1 Hour 25 Minutes",
                help = "<LOC 1h25MinDesc>Set the Wait Time to 1 Hour 25 Minutes",
                key = 5100,
            },	
            {
                text = "<LOC 1h30Min>1 Hour 30 Minutes",
                help = "<LOC 1h30MinDesc>Set the Wait Time to 1 Hour 30 Minutes",
                key = 5400,
            },				
        },
    },
