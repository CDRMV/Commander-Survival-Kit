...
function LayoutTabs(controls)
    ...
    local techFiles = {
		...
		t35 = '/mods/Commander Survival Kit Units/icons/Techlevels/t35_btn_',
        t4 = '/game/construct-tech_btn/t4_btn_',
		t5 = '/mods/Commander Survival Kit Units/icons/Techlevels/t5_btn_',
		t6 = '/mods/Commander Survival Kit Units/icons/Techlevels/t6_btn_',
    ...
    LayoutHelpers.AtLeftTopIn(controls.constructionTab, controls.constructionGroup, 30, 7)
