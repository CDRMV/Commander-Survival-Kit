...
local StructureUnit = DefaultUnits.StructureUnit2
...
AStructureUnit = ClassUnit(StructureUnit) {
	GetSkirtRect = function(self)
        local bp = self:GetBlueprint()
        local x, y, z = unpack(self:GetPosition())
        local fx = x - bp.Footprint.SizeX*.5
...
ALaserFenceUnit = Class(AStructureUnit) {

	OnCreate = function(self, builder, layer)
        AStructureUnit.OnCreate(self, builder, layer)
...
ALaserFenceDummyUnit = Class(AStructureUnit) {
