...
MNA_PARA_LINF0000 = Class(SingleBeamProjectile) {
    ...
    OnImpact = function(self, TargetType, targetEntity)	
			...
			self.Manip:PlayAnim('/mods/Commander Survival Kit/projectiles/Parachutes/Parachute/Paracute_Dummy_02/Paracute_Dummy_02_PARACHUTE_LAND_01.sca', false):SetRate(1.0)	
