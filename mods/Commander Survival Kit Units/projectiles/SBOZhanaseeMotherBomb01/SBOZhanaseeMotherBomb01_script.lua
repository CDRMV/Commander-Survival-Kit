...
local TArtilleryProjectilePolytrail = import('/lua/seraphimprojectiles.lua').SZhanaseeBombProjectile
local RandomFloat = import('/lua/utilities.lua').GetRandomFloat
local VizMarker = import('/lua/sim/VizMarker.lua').VizMarker

SBOZhanaseeMotherBomb01 = Class(TArtilleryProjectilePolytrail) {
 OnImpact = function(self, TargetType, TargetEntity) 
        
        local FxFragEffect = EffectTemplate.SDFSinnutheWeaponHit01 
        local ChildProjectileBP = '/Mods/Commander Survival Kit Units/projectiles/SBOOtheTacticalBomb03/SBOOtheTacticalBomb03_proj.bp'  
...
TypeClass = SBOZhanaseeMotherBomb01
