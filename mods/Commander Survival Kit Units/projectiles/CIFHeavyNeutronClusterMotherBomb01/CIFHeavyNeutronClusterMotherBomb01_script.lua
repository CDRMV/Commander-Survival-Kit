...
TIFHeavyNapalmMotherBomb01 = Class(TArtilleryProjectilePolytrail) {
 OnImpact = function(self, TargetType, TargetEntity) 
        
        local FxFragEffect = EffectTemplate.TFragmentationSensorShellFrag 
        local ChildProjectileBP = '/Mods/Commander Survival Kit Units/projectiles/CIFNeutronClusterBomb04/CIFNeutronClusterBomb04_proj.bp'  
...
TypeClass = TIFHeavyNapalmMotherBomb01
