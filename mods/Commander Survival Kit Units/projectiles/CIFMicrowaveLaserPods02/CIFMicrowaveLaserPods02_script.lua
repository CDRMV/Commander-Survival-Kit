...
CIFMicrowaveLaserPods02 = Class(import('/lua/cybranprojectiles.lua').CDFBrackmanHackPegProjectile02) {
    ...
    WaitingForDeath = function(self)
        ...
        local PrimaryHackProjectiles = {
                  '/mods/Commander Survival Kit Units/effects/Entities/MicrowaveLaserPodEffect01/MicrowaveLaserPodEffect01_proj.bp',
                  '/mods/Commander Survival Kit Units/effects/Entities/MicrowaveLaserPodEffect02/MicrowaveLaserPodEffect02_proj.bp',
                  '/mods/Commander Survival Kit Units/effects/Entities/MicrowaveLaserPodEffect03/MicrowaveLaserPodEffect03_proj.bp',
        }
