...
TIFBlu3000 = Class(SingleBeamProjectile) {
	...
	SingleBeamProjectile.OnCreate(self)
		...
		BombMesh = '/mods/Commander Survival Kit Units/meshes/UEF/BluBomb/TIFBlu3000_mesh',
	...
	OnImpact = function(self, TargetType, TargetEntity)
		...
		self.Bomb:Destroy()
			...
			self:CreateProjectile('/mods/Commander Survival Kit Units/effects/entities/LargeBlastEffect01/LargeBlastEffect01_proj.bp', 0, 0, 0, 0, 0, 1)
			nukeProjectile = self:CreateProjectile('/mods/Commander Survival Kit Units/effects/Entities/Blu3000/Blu3000EffectController01/Blu3000EffectController01_proj.bp', 0, 0, 0, nil, nil, nil):SetCollision(false)
