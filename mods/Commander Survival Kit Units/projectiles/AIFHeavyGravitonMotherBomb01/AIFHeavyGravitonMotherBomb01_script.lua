...
local TArtilleryProjectilePolytrail = import('/lua/aeonprojectiles.lua').AGravitonBombProjectile
local RandomFloat = import('/lua/utilities.lua').GetRandomFloat
local VizMarker = import('/lua/sim/VizMarker.lua').VizMarker

AIFHeavyGravitonMotherBomb01 = Class(TArtilleryProjectilePolytrail) {
 OnImpact = function(self, TargetType, TargetEntity) 
        
        local FxFragEffect = EffectTemplate.ALightMortarHit01 
        local ChildProjectileBP = '/Mods/Commander Survival Kit Units/projectiles/AIFBombGraviton02/AIFBombGraviton02_proj.bp'  
...
TypeClass = AIFHeavyGravitonMotherBomb01
