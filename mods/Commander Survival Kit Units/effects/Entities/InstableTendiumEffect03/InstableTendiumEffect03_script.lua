...
InstableTendiumEffect03 = Class(EmitterProjectile) {

    FxTrails = CSKEffectTemplate.InstableTendiumFireballTrail,
    ...
    EffectThread = function(self)
        ...
        local emitters = {}
        for k, v in CSKEffectTemplate.InstableTendiumFireball do
    ...
    OnImpact = function(self, targetType, targetEntity)
        for k, v in CSKEffectTemplate.InstableTendiumFireballHit do
...
TypeClass = InstableTendiumEffect03
