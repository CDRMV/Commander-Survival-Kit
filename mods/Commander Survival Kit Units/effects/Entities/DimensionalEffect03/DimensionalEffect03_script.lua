...
DimensionalEffect03 = Class(EmitterProjectile) {

    FxTrails = CSKEffectTemplate.DimensionalFireballTrail,
    ...
    EffectThread = function(self)
        ...
        local emitters = {}
        for k, v in CSKEffectTemplate.DimensionalFireball do
    ...
    OnImpact = function(self, targetType, targetEntity)
        for k, v in CSKEffectTemplate.DimensionalFireballHit do
