...
SmallInstableTendium = Class(NullShell) {
    ...
    OnCreate = function(self)
        ...
        self.InstableTendiumFxScale = 0.1
    ...
    CoreEffects = function(self, bag, lifetime)
        ...
        CreateLightParticleIntel( self, -1, self.Army, (10 * self.InstableTendiumFxScale), 2, 'glow_02', 'ramp_green_06')
    ...
    AftermathExplosion = function(self, bag, lifetime, wreck)
        ...
        CreateLightParticleIntel (self, -1, self.Army, (10 * self.InstableTendiumFxScale), 10, 'glow_03', 'ramp_green_06')
    ...
    AftermathFireArmsRandom = function(self, bag, lifetime, wreck)
		...
		local FireCntrTemp2 =  CSKEffectTemplate.InstableTendiumFireArmCenter3
        ...
        for k, v in FireCntrTempl do
            local emit = CreateEmitterAtEntity( self, self.Army, v ):ScaleEmitter( self.InstableTendiumFxScale + 0.5)
            self.Trash:Add( emit )
            bag:Add( emit )
		...
		for k, v in FireCntrTemp2 do
            local emit = CreateEmitterAtEntity( self, self.Army, v ):ScaleEmitter( self.InstableTendiumFxScale)
            self.Trash:Add( emit )
            bag:Add( emit )
        end
...
TypeClass = SmallInstableTendium
