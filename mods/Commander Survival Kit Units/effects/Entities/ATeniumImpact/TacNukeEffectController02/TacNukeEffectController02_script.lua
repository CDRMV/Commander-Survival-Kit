...
TacNukeEffectController01 = Class(NullShell) {
    ...
    CreateInitialFireballSmokeRing = function(self)
        ...
        for i = 0, (sides-1) do
            ...
            self:CreateProjectile('/mods/Commander Survival Kit Units/effects/Entities/ATeniumImpact/TacNukeShockwave01/TacNukeShockwave01_proj.bp', X * OffsetMod , 0.15, Z * OffsetMod, X, 0, Z)
    ...
    CreateOuterRingWaveSmokeRing = function(self)
        ...
        for i = 0, (sides-1) do
            local X = math.sin(i*angle)
            local Z = math.cos(i*angle)
            local proj =  self:CreateProjectile('/mods/Commander Survival Kit Units/effects/Entities/ATeniumImpact/TacNukeShockwave02/TacNukeShockwave02_proj.bp', X * OffsetMod , 0.05, Z * OffsetMod, X, 0, Z)
	...
	CreateOuterRingWaveSmokeRing2 = function(self)
        ...
        for i = 0, (sides-1) do
            local X = math.sin(i*angle)
            local Z = math.cos(i*angle)
            local proj =  self:CreateProjectile('/mods/Commander Survival Kit Units/effects/Entities/ATeniumImpact/TacNukeShockwave03/TacNukeShockwave03_proj.bp', X * OffsetMod , 0.05, Z * OffsetMod, X, 0, Z)
                :SetVelocity(velocity)
            table.insert( projectiles, proj )
        end  
