...
XRS0204NaniteCapsule = Class(SinglePolyTrailProjectile) {
	...
	OnImpact = function(self, TargetType, targetEntity)
		...
		local ShieldUnit =CreateUnitHPR('UCRSXN0204', self:GetArmy(), location[1], location[2], location[3], 0, 0, 0)
		end
	end,

}

TypeClass = XRS0204NaniteCapsule