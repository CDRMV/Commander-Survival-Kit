...
XES0205Dropcontainer = Class(SingleBeamProjectile) {
	...
	OnImpact = function(self, TargetType, targetEntity)
		...
		local ShieldUnit =CreateUnitHPR('DCESX0205', self:GetArmy(), location[1], location[2], location[3], 0, 0, 0)
		end
	end,
}


TypeClass = XES0205Dropcontainer