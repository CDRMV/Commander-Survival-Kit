...
Text:SetColor('FFffd700')
Text:SetText('Oum-Eoshi (Translated):')
Text.Depth:Set(30)
...
Text2:SetText('The Warrior has arrived very good.')
Text2.Depth:Set(30)
...
Text3:SetText('Prepare your Base for the upcoming Battle.')
Text3.Depth:Set(30)
...
Text4:SetText('We will transfer the points soon.')
Text4.Depth:Set(30)
...
Text5:SetText('Stay tuned for Updates.')
Text5.Depth:Set(30)
