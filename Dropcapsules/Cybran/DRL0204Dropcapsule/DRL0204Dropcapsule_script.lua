...
DRL0204Dropcapsule = Class(CLOATacticalMissileProjectile) {
	...
	OnImpact = function(self, TargetType, targetEntity)
		...
		local ShieldUnit =CreateUnitHPR('DRL0204', self:GetArmy(), location[1], location[2], location[3], 0, 0, 0)
	end,
}

TypeClass = DRL0204Dropcapsule